...
fill_var = NULL
color_var = "ORR_Lugano"


wrapper_core_box_plot(data = data, x_var = x_var, y_var = y_var, facet_var = facet_var, color_var = color_var, fill_var = fill_var)
...
wrapper_core_box_plot_yvars_strat(data, y_vars = y_vars, x_var = x_var, facet_var = facet_var, fill_var = fill_var, color_var = color_var)
