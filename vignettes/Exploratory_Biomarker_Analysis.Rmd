...
ggp +
  ggpp::geom_table_npc(data = tb, aes(npcx = x, npcy = y, label = label), size = 3, hjust = 1, table.theme = ggpp::ttheme_gtminimal)
...
### Display results from Cox regression as table on the KM plot using stratification
...
tb <- tibble::tibble(x = c(0.5, 1), y = 1, label = tb)
