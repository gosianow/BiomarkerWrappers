...
wrapper_tile_plot1_core(bdata, x_var = "Patient_ID", y_vars = c("BCL2_by_IHC", "BCL2_by_FISH"))


### Plot generated using geom_col. It has substantially smaller size when sample size is large.

wrapper_tile_plot2_core(bdata, x_var = "Patient_ID", y_vars = c("BCL2_by_IHC", "BCL2_by_FISH"))
