...
#' 
#' @export
wrapper_log_rank_test_core_simple_strat <- function(data, tte_var, censor_var, covariate_var, strata_vars = NULL, strat1_var = NULL, strat2_var = NULL, strat1_dummy = FALSE, strat2_dummy = FALSE, variable_names = NULL, caption = NULL, strat1_levels = "fixed", sr_times = NULL, print_nevent = TRUE, print_mst = TRUE, print_hr = TRUE, print_total = TRUE, print_pvalues = TRUE, print_adjpvalues = TRUE){
...
#' @export
wrapper_log_rank_test_biomarker <- function(data, tte_var, censor_var, biomarker_vars, treatment_var = NULL, strata_vars = NULL, strat2_var = NULL, strat1_dummy = FALSE, strat2_dummy = FALSE, variable_names = NULL, caption = NULL, strat1_levels = "fixed", sr_times = NULL, print_nevent = TRUE, print_mst = TRUE, print_hr = TRUE, print_total = TRUE, print_pvalues = TRUE, print_adjpvalues = TRUE){
...
#' @export
wrapper_log_rank_test_treatment <- function(data, tte_var, censor_var, treatment_var, biomarker_vars = NULL, strata_vars = NULL, strat2_var = NULL, strat1_dummy = FALSE, strat2_dummy = FALSE, variable_names = NULL, caption = NULL, strat1_levels = "fixed", sr_times = NULL, print_nevent = TRUE, print_mst = TRUE, print_hr = TRUE, print_total = TRUE, print_pvalues = TRUE, print_adjpvalues = TRUE){
  ...
  wrapper_res <- lapply(1:length(biomarker_vars), function(i){
    ...
    wrapper_res <- wrapper_log_rank_test_core_simple_strat(data = data, tte_var = tte_var, censor_var = censor_var, covariate_var = covariate_var, strata_vars = strata_vars, strat1_var = strat1_var, strat2_var = strat2_var, strat1_dummy = strat1_dummy, strat2_dummy = strat2_dummy, variable_names = variable_names, caption = caption, strat1_levels = strat1_levels, sr_times = sr_times, print_nevent = print_nevent, print_mst = print_mst, print_hr = print_hr, print_total = print_total, print_pvalues = print_pvalues, print_adjpvalues = print_adjpvalues)
